...
exports.mergePieceToBoard = mergePieceToBoard;
exports.clearLines = clearLines;
exports.addPenalityLines = addPenalityLines;
const tetrominoes_1 = require("./tetrominoes");
function checkCollision(board, piece) {
    const shape = tetrominoes_1.TETROMINO_SHAPES[piece.type][piece.rotation];
